...
from dashboard.components.models import render_institutional_metrics, render_paper_trading_scorecard
...
def prerender_all() -> dict:
    ...
    chart_futs = {
        ...
        "paper_trading_scorecard": executor.submit(_safe_html, render_paper_trading_scorecard),
    ...
    def _wait(key, timeout):
        try:
            ...
            if key in ("news", "market_mood", "decision_quality", "counterfactual",
                       ...
                       "paper_trading_scorecard", "regime_performance"):
    ...
    ci = {
        ...
        "paper_trading_scorecard": _wait("paper_trading_scorecard", 15),
